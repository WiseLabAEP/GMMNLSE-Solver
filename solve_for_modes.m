...
Nf = 10; % number of frequency points at which the modes will be calculated
lambda0 = 1030e-9; % center wavelength, in m
lrange = 80e-9; % wavelength range, in m. If 0 only the center wavelength will be used
num_modes = 7; % number of modes to compute
radius = 8; % outer radius of fiber, in um
folder_name = 'Fibers/GRIN6'; % folder where the output will be stored
...
extra_params.ncore_diff = 0.0064; % difference between the index at the center of the core, and the cladding
