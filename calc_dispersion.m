...
lrange = 80e-9; % wavelength range, in m. Should be the same as the range used to calculate the modes
modes_list=1:6; % usually just 1:num_modes, but it can be different

polynomial_fit_order = 7;
num_disp_orders = 4; % i.e. if this is 3, 4 coefficients will be calculated, including the 0th order

radius = 8; % Only needed for the file name
folder_name = 'Fibers/GRIN6';
